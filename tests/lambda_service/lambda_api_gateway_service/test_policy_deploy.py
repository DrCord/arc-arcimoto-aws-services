...
class TestPolicyDeploy(unittest.TestCase):
    ...
    # test successes
    def test_policy_deploy_success(self):
    ...
    # test errors
    def test_policy_deploy_error_input_api_arn_invalid_type(self):
    ...
    def test_policy_deploy_error_input_lambda_arn_invalid_type(self):
        with self.assertRaises(ValueError):
            self.LambdaServiceObject.policy_deploy(
                api_arn=self.api_arn,
    ...
    def test_policy_deploy_error_input_mute_invalid_type(self):
        with self.assertRaises(ValueError):
            self.LambdaServiceObject.policy_deploy(
                api_arn=self.api_arn,
                lambda_arn=self.lambda_arn,
    ...
    def test_policy_deploy_error_lambda_name_not_found(self):
    ...
    def test_policy_deploy_error_lambda_name_alias_not_found(self):
        self.LambdaServiceObject.create(
            function_name=self.function_name,
            description=self.default_description,
            zip_bytes=self.LambdaServiceObject.zip_bytes,
